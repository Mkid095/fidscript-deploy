/**
 * Pure helpers for the project Activity feed.
 *
 * Owns the PlatformEvent → ActivityEvent transformation, the icon + color
 * classification, the relative-time formatter, and the message templates. No
 * React, no SDK calls.
 */
...
export const EVENT_DESCRIPTIONS: Record<string, (m: Record<string, unknown>) => string> = {
