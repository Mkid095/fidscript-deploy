...
export function CreateInvitationModal({ projectId, onCreated, onClose }: CreateInvitationModalProps) {
  ...
  return (
    <Modal isOpen onClose={onClose} title="New Invitation" size="sm">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end gap-2">
          ...
          <Button variant="primary" size="sm" type="submit" loading={loading}>Send Invitation</Button>
        </div>
      </form>
    </Modal>
  );
