  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center gap-3 mb-6">
        <HugeiconsIcon icon={GlobalIcon} size={20} className="text-[var(--text-muted)]" />
        <h1 className="text-xl font-bold text-[var(--text-muted)]">Domains</h1>
      ...
      <div className="bg-[var(--rail)]/50 border border-[var(--rail-light)] rounded-lg p-3 flex items-start gap-2">
        ...
        <p className="text-xs text-[var(--text-muted)]">
          Backend inventory ready: <Link href="/docs/phases/frontend/backend/projects-deployments-domains" className="text-[var(--accent)] hover:text-[var(--accent)]">DOM-01..06</Link>.
