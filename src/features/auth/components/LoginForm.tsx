...
import { Lock, Mail, ChevronRight, Zap, Terminal } from 'lucide-react';
...
export default function LoginForm({ onNavigate }: LoginFormProps) {
  ...
  return (
    <div className="max-w-md mx-auto px-6 py-20 relative">
      <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[300px] h-[300px] bg-red-600/5 blur-[80px] rounded-full pointer-events-none" />
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-lg bg-slate-950 border border-slate-800 text-white font-mono text-xs focus:border-red-500 outline-none transition"
          ...
          >
            {loading ? (
              <span className="flex items-center gap-1">
                <span className="w-2 h-2 rounded-full bg-white animate-ping" /> Checking...
              </span>
            ) : (
              <>
