...
| **Frontend status** | F00 design system ✅ verified (live on deploy.fidscript.com). F01 public site ✅ verified (live). F02 auth ✅ implemented. F03 onboarding ✅ implemented (`/onboarding` health board + `GET /health/email`). F04–F11 — **specs pending** (in implementation order after F02/F03 review). |
